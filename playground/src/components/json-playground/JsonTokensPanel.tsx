/**
 * JsonTokensPanel — JSON variant of TokensPanel.
 *
 * Identical behavior; reads from `useJsonPlaygroundStore`.
 */
...
export function JsonTokensPanel() {
  const tokens = useJsonPlaygroundStore((s) => s.tokens)
  const setTokenHex = useJsonPlaygroundStore((s) => s.setTokenHex)
  const resetTokens = useJsonPlaygroundStore((s) => s.resetTokens)
