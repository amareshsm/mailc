...
export const COMPONENT_METADATA: Record<string, ComponentMetadata> = {
  ...
  'mc-class': {
    ...
    attributes: {
      ...
      'text-align':     { type: 'enum',            required: false, description: 'Text alignment for components using this class.', example: 'center', values: ['left', 'center', 'right'], hasEmailCompatibilityNotes: false },
      ...
      'border-style':   { type: 'enum',            required: false, description: 'Border style for components using this class.', example: 'solid', values: ['solid', 'dashed', 'dotted', 'none'], hasEmailCompatibilityNotes: false },
  ...
  'mc-section': {
    ...
    attributes: {
      ...
      'text-align':          { type: 'enum',             required: false, description: 'Text alignment for inline content.', example: 'center', values: ['left', 'center', 'right'], default: 'center', hasEmailCompatibilityNotes: false, isCssPropAttr: true, classHint: 'text-#value' },
  ...
  'mc-button': {
    ...
    attributes: {
      ...
      'text-align':       { type: 'enum',             required: false, description: 'Text alignment inside button.', example: 'center', values: ['left', 'center', 'right'], default: 'center', hasEmailCompatibilityNotes: false, isCssPropAttr: true, classHint: 'text-#value' },
      'text-decoration':  { type: 'enum',             required: false, description: 'Text decoration on the link.', example: 'none', values: ['none', 'underline'], hasEmailCompatibilityNotes: false, isCssPropAttr: true, classHint: 'underline or no-underline' },
  ...
  'mc-divider': {
    ...
    attributes: {
      ...
      'border-style':                 { type: 'enum',             required: false, description: 'Border style.', example: 'solid', values: ['solid', 'dashed', 'dotted'], default: 'solid', hasEmailCompatibilityNotes: false, isCssPropAttr: true, classHint: 'border-#value' },
